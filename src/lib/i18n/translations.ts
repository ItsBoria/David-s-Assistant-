const en = {
  ...
  "myWeek.pageTitle": "My Week",
  "myWeek.pageDescription":
    "A read-only view of this work week using your saved work hours and inbox mission target dates.",
  "myWeek.weekRange": "{{startsOn}}–{{endsOn}}",
  "myWeek.summaryTitle": "Planning inputs",
  ...
  "myWeek.plan.title": "Suggested plan",
  ...
  "myWeek.plan.reason.deadlinePassed": "the deadline has passed",
  "myWeek.plan.reason.noAllowedDay": "there is no eligible day this week",
  "myWeek.plan.reason.noAvailableHours": "the eligible hours are already blocked",
  "myWeek.plan.reason.fixedConflict": "the fixed time conflicts",
  "myWeek.plan.reason.durationCannotFit": "the full duration does not fit",
  "myWeek.plan.reason.minimumSessionCannotFit":
    "no valid minimum-sized session fits",
  "myWeek.plan.reason.dailyLimitReached": "the daily work limit was reached",
  "myWeek.plan.reason.lockedMission": "the locked session must be preserved",
  "settings.language.english": "English",
  "settings.language.hebrew": "Hebrew",
  "settings.pageTitle": "Settings",
  "settings.pageDescription":
    "Shape the availability rules the planner will use later.",
  "settings.workHours.title": "Weekly work hours",
  "settings.workHours.description":
    "Choose the normal Sunday-to-Thursday hours when missions may be planned.",
  "settings.workHours.startsAt": "Starts",
  "settings.workHours.endsAt": "Ends",
  "settings.workHours.save": "Save work hours",
  "settings.workHours.saving": "Saving work hours…",
  "settings.workHours.saved": "Work hours saved.",
  "settings.workHours.unavailable":
    "Work hours are temporarily unavailable. Please try again.",
