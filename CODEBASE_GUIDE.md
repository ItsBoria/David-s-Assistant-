...
- **2026-07-13 — Database test portability:** Rewrote the completion snapshot pgTAP assertion to avoid a nested data-modifying CTE rejected by PostgreSQL.
