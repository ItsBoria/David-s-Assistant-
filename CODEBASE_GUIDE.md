...
- Recurrence rule validation and deterministic civil-date generation are implemented, including incremental cursor semantics, but there is no repository/service, transactional occurrence insertion, cursor advancement, UI, scheduler orchestration, or editing-scope transaction yet.
